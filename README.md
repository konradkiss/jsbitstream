...
* **readU4(), readU8(), readU()16, readU32(), writeU4(), writeU8(), writeU()16, writeU32()** *Reads from and writes fixed size integers into the bitstream. Useful when you know how large a specific value can be.*
